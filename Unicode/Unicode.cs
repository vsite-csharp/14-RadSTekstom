...
namespace Vsite.CSharp.RadSTekstom
{
    class Unicode
    {
        // Pogledati imena donjih varijabli te sadržaje tekstova
        ...
        static void Main(string[] args)
        {
            ...
            // Selektirati prethodne dvije naredbe i iz kontekstnog izbornika odabrati naredbu "Execute in interactive" te provjeriti ispis
