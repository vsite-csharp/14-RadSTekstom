...
namespace Vsite.CSharp.RadSTekstom
{
    class PretvorbaStringaUBroj
    {
        ...
        // Dodati u donju metodu poziv metode TryParse. Ako je pretvorba uspjela, ispisati rezultat, inače ispisati poruku "Neuspješno". Pokrenuti program i provjeriti ispise
        public static void PokušajUDouble(string tekst)
        {
            if (double.TryParse(tekst, out double result))
