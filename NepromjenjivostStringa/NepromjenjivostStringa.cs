...
namespace Vsite.CSharp.RadSTekstom
{
    class NepromjenjivostStringa
    {
        static void Main(string[] args)
        {
            ...
            // Pogledati što se događa s gornjim memorijama tijekom izvođenja donje naredbe. - tekst i tekstPreslika pokazuju na isto mjesto u memoriji dok se tekst ne promjeni
            tekst += "dan!";
