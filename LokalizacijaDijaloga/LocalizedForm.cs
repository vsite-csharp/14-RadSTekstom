...
namespace Vsite.CSharp.RadSTekstom
{
    public partial class LocalizedForm : Form
    {
        ...
        // :075 Buildati program i provjeriti kamo su se prevedeni resursi pohranili (tj. pogledati sadržaj potkazala bin\Debug)
        // :076 Pokrenuti program i provjeriti mijenja li se tekst kontrola pri promjeni izbora u padajućoj listi na formi
        // :077 U prozoru Properties za LocalizedForm promijeniti language na "German" te prevesti tekstove:
        //  - naslov "Main Form" prevesti u "Hauptform"
        //  - "Language:" prevesti u "Sprache:"
        //  - "Hello!" prevesti u "Guten Tag!"
        // :078 Pokrenuti program i provjeriti prikazuju li se njemački prijevodi ispravno 
        // :079 Pokrenuti testove (2 testa iz grupe "TestLokalizacijeDijaloga" moraju proći) 
